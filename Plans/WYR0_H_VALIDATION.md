...
`219bcb17a626a2cb327f8d77a2b35d2f01bc7dd1`. The canonical `xtask`
...
- Wyrmroot: `219bcb17a626a2cb327f8d77a2b35d2f01bc7dd1`
- Rust fork: `a92dc7f7464ad6ddfece4402bd7b86dbfa86166d`
- request: `target/wyr0-h/candidate-dw-1d6b7f4d__wyr-219bcb17__rust-a92dc7f7/request.toml`
...
- default profile: 1 vCPU, 2 GiB
- SMP profile: 4 vCPUs, 2 GiB

The final Wyrmroot commits after the initial H implementation only changed
`xtask` and native diagnostic reporting. Rebuilding the native targets retained
the exact payload identities below.
...
- full locked, offline workspace tests across all targets;
- 58 `xtask` tests, with the accepted-toolchain environment gate intentionally
  ignored by the ordinary host suite;
...
The final canonical paired command ran both profiles against ESP
`49e33754430a1a341014f89fd05fdd162e71bf3adb2b7a48ac4377ca02b36060`
and correctly returned nonzero:

- `default`: structured guest `FAIL`, test ID 18, detail `0xB0410005`,
...
- `smp`: both firmware and Deepwyrm entry completed, then the guest shut down
...
The two results name the same ESP hash and exact Deepwyrm, Wyrmroot, and Rust
revisions. No host-only result is claimed as I0 or I1 guest acceptance.
